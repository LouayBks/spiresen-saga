output "static_site_bucket_name" {
  description = "Frontend S3 bucket name — set as the STATIC_SITE_BUCKET_NAME GitHub Actions variable (int environment)."
  value       = module.static_site.bucket_name
}

output "static_site_distribution_id" {
  description = "Frontend CloudFront distribution ID — set as the STATIC_SITE_DISTRIBUTION_ID GitHub Actions variable (int environment)."
